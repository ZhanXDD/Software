...
import dataAccess.DataAccessYao2;
...
class DataAccessAddMoney2Test {
	static DataAccessYao2 sut = new DataAccessYao2(ConfigXML.getInstance().getDataBaseOpenMode().equals("initialize"));
	 ...
	 * @Test
	 * 
	 * @DisplayName("Test4: lanzado UserNotInDBException") void testAddMoney4() {
	 * testDA.open(); assertThrows(UserNotInDBException.class, () ->
	 * sut.addMoney(new Account("a",""), card, 10)); testDA.close(); }
	 */
}
