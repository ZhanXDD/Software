...
public class FindQuestionsGUI extends JFrame {
	...
	private final JLabel jLabelBets = new JLabel("Bets");
	...
	private void jbInit()
	{
		...
		this.setSize(new Dimension(981, 500));
...
//					jCalendar1.setCalendar(calendarAct);
		...
		scrollPaneQueries.setBounds(new Rectangle(40, 273, 383, 116));
		scrollPaneBets.setBounds(new Rectangle(40, 273, 383, 116));

		/**
		 * Pick an event from the list and show all questions
		 */
		tableEvents.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				jLabelBets.setText("Bets");
...
///////////////////////////////////////////////////////////////////////////
		...
		/**
		 * Pick a question from the list and show all bets
		 */
		tableQueries.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				Vector<Bet> bets=q.getBets();
				
				if (bets.isEmpty())
					jLabelBets.setText("There are no bets for the question " + q.getQuestion());
				else 
					jLabelBets.setText("Selected question " + q.getQuestion());
...
//////////////////////////////////
		...
		scrollPaneBets.setBounds(475, 273, 383, 116);
		
		
		jLabelBets.setBounds(475, 249, 383, 13);
